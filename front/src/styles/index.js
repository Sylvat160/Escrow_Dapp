const styles = {
  label: 'font-rajdhani font-semibold text-md text-white mb-3',
  input:
    'bg-siteDimBlack text-white outline-none focus:outline-siteViolet p-4 rounded-md  md:w-[97%] w-[25rem]',
  ...
  btn: 'px-4 py-2 rounded-lg bg-siteViolet w-fit font-rajdhani font-bold',
}
